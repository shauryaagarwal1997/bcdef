...
function setup(){
    ...
    butiss.position(displayWidth/2-210,displayHeight/2-100)
...
stroke("black")
strokeWeight(8)
text("LIVE ISS DATA",displayWidth/2-240,displayHeight/2-240)

textSize(60);
fill("red");
stroke("black")
strokeWeight(8)
text("LET'S CHECK THE LIVE POSITIONS OF THE ISS",displayWidth/2-690,displayHeight/2-150)
}
butiss.mousePressed(()=>{
    appState=1;
})
